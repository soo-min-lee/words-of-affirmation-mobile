...
        if (distanceBetweenLips[result] > 5 && !clickOnce[result]) {
...
function draw() {
  background("#ffffff");
  image(video, 0, 0, windowWidth, windowHeight); // Full window size for video
...
      // Apply scaling
      let scaledX = keypoint[0] * scaleX;
      let scaledY = keypoint[1] * scaleY;

      // Draw the keypoints (optional, for visual debugging)
//       fill(0, 255, 0);
//       noStroke();
